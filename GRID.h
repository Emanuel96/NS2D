...
void GRID_CYLINDER( double XD, double YD, int NPX, int NPY, double *X, double *Y, double *XU, double *XV, double *YU, double *YV, double *DX, double *DY, double *DXU, double *DXV, double *DYU, double *DYV)
{
    int i, j, k;
